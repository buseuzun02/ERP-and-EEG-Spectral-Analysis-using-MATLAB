% Q3.m – Questions 3a and 3b: ERP and Spectral Analysis
clear; clc; close all;

%% --- Question 3a: ERP in the Time Domain ---
% Load EEG data
load('Q3_Data.mat');  % EEG structure is loaded
...
title('ERP - Channel 1 (Q3\_Data.mat)');
grid on;

%% --- Question 3b: Frequency-Domain Comparison ---
...
% 2. Power spectrum of ERP
psd2 = abs(fft(erp)).^2;

% 3. Average of trial-wise FFTs
n_trials = size(data, 3);
fft_trials = fft(squeeze(data(1, :, :)), [], 1);  % time x trials
psd3 = mean(abs(fft_trials).^2, 2);
